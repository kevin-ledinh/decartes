...
class OcadoSpiderNew(scrapy.Spider):
    name = "OcadoSpiderNew"
    storeName = "Ocado"
    timenow = datetime.datetime.utcnow()
    morrisonsUrl = "https://www.ocado.com/products/"
    webShopApi = "https://www.ocado.com/webshop/api/v1/products?skus="
    imageUrl = "https://www.ocado.com/productImages/"
    urlJsonPath = "./urlList/ocadoUrls.json"
    reqBody = {}
    headers = {
